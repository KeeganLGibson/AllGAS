...
void AAllGASCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AAllGASCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AAllGASCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AAllGASCharacter::OnResetVR);
}


void AAllGASCharacter::OnResetVR()
{
	// If AllGAS is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in AllGAS.Build.cs is not automatically propagated
...
void AAllGASCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AAllGASCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
